...
def testAesUST(content_img, style_img):
    ...
    # Models                  
    parser.add_argument('--vgg', type=str, default = './AesUST/models/vgg_normalised.pth')
    parser.add_argument('--decoder', type=str, default = './AesUST/models/decoder.pth')
    parser.add_argument('--transform', type=str, default = './AesUST/models/transformer.pth')
    parser.add_argument('--discriminator', type=str, default = './AesUST/models/discriminator.pth')
